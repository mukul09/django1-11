...
class Profile(models.Model):
	...
	#following		= models.ManyToManyField(User, related_name='user_following', blank=True)		#user.profile_set.all()
...
def post_save_user_receiver(sender, instance, created, *args, **kwargs):
	if created:
		...
		profile.followers.add(4)   #this number is the id of the other user who is following
