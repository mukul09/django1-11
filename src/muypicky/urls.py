...
urlpatterns = [
   ...
   # url(r'^restaurants/$', RestaurantListView.as_view(), name='restaurants'),
    #url(r'^restaurants/create/$',RestaurantCreateView.as_view(), name ='restaurants-create'), #class based view
    #url(r'^restaurants/create/$',restuarant_createview), # function based view
    ...
    # url(r'^restaurants/asianfusion/$', AsianFusionRestaurantListView.as_view())
]
